...
def test_find_opponent_metrics(team_config, pref_unmet_sched, divteam_metrics):
    from scheduler_service.algorithm.teampreference import find_opponent_metrics
...
def test_find_swap_candidates(team_config, pref_unmet_sched, divteam_metrics):
    from scheduler_service.algorithm.teampreference import find_swap_candidates
