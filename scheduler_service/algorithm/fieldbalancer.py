...
from scheduler_service.util.sched_exceptions import FieldAvailabilityError, TimeSlotAvailabilityError, FieldTimeAvailabilityError, \
...
class FieldBalancer(object):
    ...
    def findMinimumCountField(self, homemetrics_list,
        ...
        # home and way teams is calculated by a penalty function for the field
        # that is applied according to how close it is or has already exceeded
        # the target counts.
        # ----
